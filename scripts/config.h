...
static const char *volumecmd[]   = { "mate-volume-controle", NULL };
static const char *gimpcmd[] 	 = { "gimp", NULL };
static const char *brwcmd[] 	 = { "chromium-browser", NULL };
static const char *pdfcmd[]   	 = { "/bin/sh", "-c", "~/.scripts/readpdf.sh", NULL };
static const char *pixcmd[] 	 = { "/bin/sh", "-c", "~/.scripts/picture.sh", NULL };
static const char *vidcmd[] 	 = { "/bin/sh", "-c", "~/.scripts/video.sh", NULL };
static Key keys[] = {
	...
	{ MODKEY,                       XK_o,      spawn,          {.v = brwcmd } },
	{ MODKEY,                       XK_p,      spawn,          {.v = pdfcmd } },
	{ MODKEY,                       XK_x,      spawn,          {.v = pixcmd } },
	{ MODKEY,                       XK_v,      spawn,          {.v = vidcmd } },
...
//	{ MODKEY,                       XK_space,  setlayout,      {0} },
	...
	{ MODKEY,			XK_Page_Up,	view, 	   {1} },
	{ MODKEY,			XK_Page_Down,	view, 	   {2} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
